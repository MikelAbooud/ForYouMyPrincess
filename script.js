...
const CONFIG = {
  ...
  chapters: [
    {
      ...
      title: "First Look",
      text:
        "From the first time i saw you i knew you will be the reason of my smile and the reason of my tears from your sweet poison. ",
   
      song: "audio/chapters/chap1.mp3"
    },
    {
      kicker: "Chapter 2",
      title: "when my love for you became more than just a feeling",
      text:
  ...
  "Because I did not want to treat you like a “maybe.” I wanted to treat you like someone important.",
    ...
    },
    {
      ...
      text:
        "the final destination is to make u mine and give you my last name thats the whole point of my life"+
        "at the same time i dont want to let you feel all my hard moments in my life because you only deserve the special and happy moments "+
       " I want you in every step i take in life and never let you feel the hard moments in it ",
...
I may not always find the perfect words, but my feeling is simple: I choose you. I want to keep making memories with you, to support you, to respect you, and to love you even more as time goes on. Thank you for being in my life. Thank you for being you. I love you today, tomorrow, and always.`,
    ...
    questions: [
      {
        ...
        options: ["Your Smile", "Your Sammetik", "Your heart", "All of the above"],
        answerIndex: 1,
        onWrong: "Wrong Babe! Of course I love everything about you but Sammetik is special",
        onCorrect: "Exactly Princess!!"
      },
      {
        q: "What’s our best Memory together?",
        options: [  "First Date", "First Kiss", "Sleeping In my heart","First Driving Lesson"],
        answerIndex: 1,
      ...
      },
      {
        ...
        options: ["Shirts", "Bracelets", "Cup", "Your art", "There is more gift in this option"],
        answerIndex: 4,
  ...
  datePicks: {
    vibe: ["Dinner date", "Movie night", "Staying at home"],
    food: ["Pizza", "Sushi", "Steak/Chicken"],
    end:  ["Long drive + music + Sleeping in my heart","Long drive + music + Sleeping in my heart"]
  },
